...
public class ArvoreBinaria<E> {
    ...
    public ArvoreBinaria<E> proximoPosOrdem() {
        ...
        while (!pilha.isEmpty()) {
            while (pilha.peek().esquerda != null) {
                pilha.push(pilha.peek().esquerda);
            }
            if (pilha.peek().direita == null) {
                resultado = pilha.pop();
                if (!pilha.isEmpty()) {
                    if (pilha.peek().direita == resultado) {
                        pilha.peek().direita = null;
                    } else {
                        pilha.peek().esquerda = null;
                    }
                }
                if (resultado != null) {
                    return resultado;
    ...
    public ArvoreBinaria<E> proximoEmNivel() {
        ...
        if (!fila.isEmpty()) {
            if (fila.getFirst().esquerda != null) {
                fila.add(fila.getFirst().esquerda);
            }
            if (fila.getFirst().direita != null) {
                fila.add(fila.getFirst().direita);
            }
